define(['dart_sdk', 'packages/source_span/source_span'], function(dart_sdk, packages__source_span__source_span) {
  ...
  const _scanner$0 = Symbol("_SpanScannerState._scanner");
  ...
  const _sourceFile$0 = Symbol("RelativeSpanScanner._sourceFile");
  const _lastSpan$0 = Symbol("RelativeSpanScanner._lastSpan");
  ...
  const _scanner$2 = Symbol("_SpanScannerState._scanner");
  ...
  const _scanner$4 = Symbol("_EagerSpanScannerState._scanner");
