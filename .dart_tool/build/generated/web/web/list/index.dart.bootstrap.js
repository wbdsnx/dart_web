...
define("index.dart.bootstrap", ["web/list/index", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__list__index || app.index).main();
  var bootstrap = {
