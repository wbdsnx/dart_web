...
let modulePaths = {
 ...
 "packages/dio/src/adapter": "packages/dio/src/adapter.ddc",
 "packages/dio/src/adapters/browser_adapter": "packages/dio/src/adapters/browser_adapter.ddc",
 "packages/dio/src/dio": "packages/dio/src/dio.ddc",
 ...
 "web/config": "config.ddc",
 "web/issue/index": "issue/index.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'index.digests',
...
define("index.dart.bootstrap", ["web/issue/index", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__issue__index || app.index).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("index.dart.bootstrap", {
    "index.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
