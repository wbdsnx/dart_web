define(['dart_sdk'], function(dart_sdk) {
  ...
  const style$0 = Symbol("ParsedPath.style");
  ...
  const separators$ = Symbol("ParsedPath.separators");
  ...
  const separators$0 = Symbol("WindowsStyle.separators");
  ...
  const style$1 = Symbol("Context.style");
